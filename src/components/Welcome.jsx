...
function Welcome() {
  ...
  return (
    <motion.section
      ...
      className="fixed inset-0 z-100 flex h-[100svh] w-full flex-col items-center justify-center overflow-hidden bg-accent text-white-soft"
    >
      <div className="flex flex-col items-center gap-5">
        <span className="text-[10px] uppercase tracking-[0.45em] text-white-soft/60">
          Est. 2024
        </span>
        <h1
